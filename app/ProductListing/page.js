    ...
    try {
      const response = await axios.post('https://api.pinata.cloud/pinning/pinFileToIPFS', formData, {
        headers: {
          ...
          'pinata_api_key': '9b7504cf79f5dce2a584', // API  key Pinata
          'pinata_secret_api_key': 'd4e4c9beaa5664f5a0c43d67a24d922ed0ba2c9eab3375b2f40da35d9975993c', // Pinata Secret API Key
        },
      });
  ...
  return (
    <div className='flex items-center justify-center h-screen bg-gradient-to-r from-gray-800 to-black' style={{ backgroundImage: 'url("./BgImg2.jpg")' }}>
      <div className='bg-white rounded-lg shadow-lg p-6 w-full max-w-lg'>
        ...
        <h2 className="text-3xl font-bold text-gray-800 text-center mb-6">Add your Car into the Marketplace</h2>
